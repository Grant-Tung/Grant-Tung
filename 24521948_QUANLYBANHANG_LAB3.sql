...
USE QUANLYBANHANG
GO
SET DATEFORMAT DMY --Dinh dang Ngay/Thang/Nam
GO
...
-- RANG BUOC
ALTER TABLE SANPHAM ADD CONSTRAINT CKDVT CHECK(DVT IN ('cay','hop','cai','quyen','chuc'))
ALTER TABLE SANPHAM ADD CONSTRAINT CKGIA CHECK(GIA >= 500)
ALTER TABLE CTHD ADD CONSTRAINT CKSL CHECK(SL >= 1)
ALTER TABLE KHACHHANG ADD CONSTRAINT CKNGDK CHECK(NGDK > NGSINH)
GO
...
('KH01','Nguyen Van A','731 Tran Hung Dao, Q5, TpHCM','08823451','22/10/1960',13060000,'22/07/2006',NULL),
('KH02','Tran Ngoc Han','23/5 Nguyen Trai, Q5, TpHCM','0908256478','03/04/1974',280000,'30/07/2006',NULL),
('KH03','Tran Ngoc Linh','45 Nguyen Canh Chan, Q1, TpHCM','0938776266','12/06/1980',3860000,'05/08/2006',NULL),
('KH04','Tran Minh Long','50/34 Le Dai Hanh, Q10, TpHCM','0917325476','09/03/1965',250000,'02/10/2006',NULL),
('KH05','Le Nhat Minh','34 Truong Dinh, Q3, TpHCM','08246108','10/03/1950',21000,'28/10/2006',NULL),
('KH06','Le Hoai Thuong','227 Nguyen Van Cu, Q5, TpHCM','08631738','31/12/1981',915000,'24/11/2006',NULL),
('KH07','Nguyen Van Tam','32/3 Tran Binh Trong, Q5, TpHCM','0916783565','06/04/1971',12500,'01/12/2006',NULL),
('KH08','Phan Thi Thanh','45/2 An Duong Vuong, Q5, TpHCM','0938435756','10/01/1971',365000,'13/12/2006',NULL),
('KH09','Le Ha Vinh','873 Le Hong Phong, Q5, TpHCM','08654763','03/09/1979',70000,'14/01/2007',NULL),
('KH10','Ha Duy Lap','34/34B Nguyen Trai, Q1, TpHCM','08768904','02/05/1983',67500,'16/01/2007',NULL)
...
-- Tao bang phu de lam cau Update
SELECT * INTO SANPHAM1 FROM SANPHAM
SELECT * INTO KHACHHANG1 FROM KHACHHANG
GO
-- Cau 2: Tang gia Thai Lan 5%
UPDATE SANPHAM1 SET GIA = GIA * 1.05 WHERE NUOCSX = 'Thai Lan'

-- Cau 3: Giam gia Trung Quoc
...
-- Cau 12
SELECT SOHD, NGHD, TRIGIA FROM HOADON WHERE MONTH(NGHD) = 1 AND YEAR(NGHD) = 2007 ORDER BY NGHD ASC, TRIGIA DESC

-- Cau 13
SELECT DISTINCT K.MAKH, K.HOTEN FROM KHACHHANG K INNER JOIN HOADON H ON K.MAKH = H.MAKH WHERE H.NGHD = '01/01/2007'

-- Cau 14
SELECT H.SOHD, H.TRIGIA FROM HOADON H INNER JOIN NHANVIEN N ON H.MANV = N.MANV WHERE N.HOTEN = 'Nguyen Van B' AND H.NGHD = '28/10/2006'

-- Cau 15
SELECT DISTINCT S.MASP, S.TENSP FROM SANPHAM S JOIN CTHD CT ON S.MASP = CT.MASP JOIN HOADON H ON CT.SOHD = H.SOHD JOIN KHACHHANG K ON H.MAKH = K.MAKH 
...
SELECT MASP, TENSP FROM SANPHAM WHERE NUOCSX = 'Trung Quoc' 
UNION 
SELECT S.MASP, S.TENSP FROM SANPHAM S JOIN CTHD CT ON S.MASP = CT.MASP JOIN HOADON H ON CT.SOHD = H.SOHD WHERE H.NGHD = '01/01/2007'

-- Cau 18
SELECT SOHD FROM HOADON H WHERE NOT EXISTS (
    SELECT * FROM SANPHAM S WHERE NUOCSX = 'Singapore' AND NOT EXISTS (
        SELECT * FROM CTHD CT WHERE CT.SOHD = H.SOHD AND CT.MASP = S.MASP
    )
)

-- Cau 19
SELECT SOHD FROM HOADON H WHERE YEAR(NGHD) = 2006 AND NOT EXISTS (
    SELECT * FROM SANPHAM S WHERE NUOCSX = 'Singapore' AND NOT EXISTS (
        SELECT * FROM CTHD CT WHERE CT.SOHD = H.SOHD AND CT.MASP = S.MASP
    )
)
